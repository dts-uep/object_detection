...
# Data path
folder_path = cf.TRAIN_DATA_PATH2
...
# Save encoder
with open("WindowsSliding_HOG_SVM/models/encoder2.pkl", "wb") as file:
...
data_resized = image_resize(data_padded, cf.MODEL_INPUT_IMAGE_SIZE2)
...
svm_classifier.fit(data_extracted, encoded_labels, epochs=cf.EPOCHS2, lr=cf.LEARNING_RATE2, stop=cf.STOP_THRESHOLD2)
...
# Save
with open("WindowsSliding_HOG_SVM/models/svm_classifier2.pkl", "wb") as file:

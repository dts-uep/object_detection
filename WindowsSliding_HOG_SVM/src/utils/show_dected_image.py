...
def display_detected_image(image:np.array, results:list, class_list:list, box_size_ratio:list,image_name:str , save:bool=False):
    ...
    for result in results:
        ...
        for object in labels[0]:
            ...
            # Draw box
            image[y-5:y+2, x:x+wth, :] = np.array([0, 0, 255]) # up margin
            ...
            # Draw label
            cv2.putText(image, class_list[object], (x, y+20), cv2.FONT_HERSHEY_SIMPLEX, box_width/500, (255,255,255), 1, cv2.LINE_AA)
